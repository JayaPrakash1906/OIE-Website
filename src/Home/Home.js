...
const Home = () => {
  return (
    <div>
            <Navbar/>
                    <div className='uppercase text-blue-600 mt-[200px] text-center font-bold font-dmsans text-5xl'>
                            Where ideas and 
                                <span className='block mt-4'>
                                    innovation Prosper
                                </span>
                    </div>
                                <div className='uppercase text-black mt-4 text-center text-3xl font-dmsans'>
                                    IIT MADRAS
                                </div>
                                <div className='grid grid-cols-2 gap-1 sm:grid-cols-3 md:grid-cols-5 md:mt-32'>
                                  <div> 
                                    <img src={img1} alt="Home image 1" className="w-[150px] h-[250px] sm:w-[180px] sm:h-[300px] md:w-[200px] md:h-[360px] object-cover rounded-xl shadow-md ml-4 md:ml-8 mt-16 md:mt-32"/>
                                  </div>

                                  <div className="flex flex-col items-center space-y-2 sm:space-y-4 ml-1">
                                    <img src={img2} alt="Home image 2" className="w-[150px] h-[250px] sm:w-[180px] sm:h-[300px] md:w-[210px] md:h-[360px] object-cover rounded-xl shadow-md"/>
                                    <img src={img3} alt="Home image 3" className="w-[150px] h-[120px] sm:w-[180px] sm:h-[150px] md:w-[210px] md:h-[200px] object-cover rounded-xl shadow-md"/>
                                  </div>

                                  <div className="flex flex-col items-center space-y-2 sm:space-y-4 mt-8 sm:mt-12 md:mt-16">
                                    <img src={img4} alt="Home image 4" className="w-[150px] h-[110px] sm:w-[180px] sm:h-[150px] md:w-[210px] md:h-[180px] object-cover rounded-xl shadow-md"/>   
                                    <img src={img5} alt="Home image 5" className="w-[150px] h-[250px] sm:w-[180px] sm:h-[300px] md:w-[210px] md:h-[360px] object-cover rounded-xl shadow-md"/>
                                  </div>

                                  <div className="flex flex-col items-center space-y-2 sm:space-y-4 mr-1">
                                    <img src={img6} alt="Home image 6" className="w-[150px] h-[250px] sm:w-[180px] sm:h-[300px] md:w-[210px] md:h-[360px] object-cover rounded-xl shadow-md"/>
                                    <img src={img7} alt="Home image 7" className="w-[150px] h-[120px] sm:w-[180px] sm:h-[150px] md:w-[210px] md:h-[190px] object-cover rounded-xl shadow-md"/>
                                  </div>

                                  <div> 
                                    <img src={img8} alt="Home image 8" className="w-[150px] h-[250px] sm:w-[180px] sm:h-[300px] md:w-[200px] md:h-[360px] object-cover rounded-xl shadow-md mr-4 md:mr-9 mt-16 md:mt-32"/>
                                  </div>
                                </div>
                      ...
                      <div className="grid md:grid-cols-7 px-10 mt-10 gap-14"> 
                          <div className="mt-16 col-span-5">
                              <div className="flex items-center">
                                    <img className="ml-16 w-14 h-14 object-cover" src={img11} alt="Nirmaan Logo" />
                                        <span className='text-4xl ml-4 font-dmsans font-bold text-green-600'>NIRMAAN</span>
                              </div>
                                  <div className="ml-16 mt-4 font-dmsans text-lg">
                                          <p>Nirmaan, The Pre-incubator of IIT Madras, is the first of its kind dedicated pre-incubator on a college campus 
                                             in the country. Its primary objective is to provide technical guidance and business mentorship to student teams, 
                                             assisting them in refining their business ideas to achieve both technical robustness and economic viability.
                                             In addition to offering a well-equipped collaborative workspace and essential financial support, Nirmaan cultivates 
                                             a supportive and encouraging environment conducive to innovation. Furthermore, the program facilitates valuable 
                                             connections between nascent startups and experienced mentors who provide specialized technical and business insights,
                                             crucial for translating ideas into successful businesses.
                                          </p>
                                  </div>
                                    <div className=" flex justify-start items-start">
                                          <button className='ml-16 mt-12 bg-green-500 text-white font-dmsans px-8 py-1 rounded-2xl hover:bg-green-600 transition'>
                                              Learn More
                                          </button>
                                   </div>  
                          </div>
                          <div className="col-span-2 flex justify-center items-center">
                                  <img className=" w-[340px] h-[260px]  mt-[80px] rounded-xl" src={img12} alt="Nirmaan Logo" />
                          </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-7 px-10 mt-10 gap-14"> 
                          <div className="mt-16 col-span-5">
                              <div className="flex items-center">
                                    <img className="ml-16 w-16 h-14 object-cover" src={img13} alt="Nirmaan Logo" />
                                        <span className='text-4xl ml-4 font-dmsans font-bold text-red-600'>CENTRE FOR INNOVATION (CFI)</span>
                              </div>
                                  <div className="ml-16 mt-4 font-dmsans text-lg">
                                          <p>The Centre for Innovation (CFI) at IIT Madras is a pioneering student-led "Tinker Lab" and one of the oldest 
                                             academic entities dedicated to “Doing by Learning”. Established by the alumni class of 1981, CFI has expanded 
                                             over the past fifteen years into a central hub focusing on nurturing innovation and technological inventions. 
                                             The centre is structured around approximately 14 'Hobby' clubs and 8 competition teams, complemented by additional 
                                             teams offering expertise in branding, engagement, finance, and web operations/coding support.
                                          </p>
                                  </div>
                                    <div className=" flex justify-start items-start">
                                          <button className='ml-16 mt-12 bg-red-500 text-white font-dmsans px-8 py-1 rounded-2xl hover:bg-red-600 transition'>
                                              Learn More
                                          </button>
                                   </div>  
                          </div>
                          <div className="col-span-2 flex justify-center items-center">
                                  <img className=" w-[340px] h-[260px]  mt-[120px] rounded-xl" src={img14} alt="cfi image" />
                          </div>
