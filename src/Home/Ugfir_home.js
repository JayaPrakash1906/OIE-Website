...
const Ugfir_home = () => {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-20 lg:px-32 font-dmsans">
        ...
        Starting a business while balancing college life and planning for the future is no easy task. The <strong>UG Founder in Residence (UG–FIR)</strong> program at IIT Madras
         is designed to empower recent graduates to pursue their entrepreneurial ambitions without financial or logistical constraints.

        </p>
        <p className="text-sm sm:text-base text-justify mb-4">
        This unique initiative offers a monthly stipend to help founders focus entirely on building their startups. Backed by the IITM alumni network and
         the Office of Alumni & Corporate Relations, the UG–FIR program provides a nurturing environment for young entrepreneurs to thrive—offering access to mentorship, targeted workshops, and the wider IIT Madras innovation ecosystem.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-20 lg:px-32 font-dmsans">
        ...
        <ul className="list-disc pl-6 text-sm sm:text-base text-justify space-y-2 ">
          <li><strong>Monthly Stipend:</strong> ₹20,000</li>
          <li><strong>Duration:</strong>  6 months (extendable up to 1 year based on performance review)</li>
          <li><strong>Support Includes:</strong> Accommodation, dedicated mentorship, and access to Nirmaan’s resources and infrastructure</li>
          <li><strong>Eligibility:</strong>  Open to recent undergraduate graduates from IIT Madras who are startup founders, preferably pre-incubated at Nirmaan, IITM</li>
        </ul>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-20 lg:px-32 font-dmsans">
        ...
        <ul className="list-disc pl-6 text-sm sm:text-base text-justify space-y-2 ">
          <li><strong>How to Apply:</strong>  Click the “Apply Now” button on the UG–FIR homepage to access the application form</li>
          <li><strong>Requirements:</strong> Submit your personal details and upload your pitch deck as part of the application</li>
          <li><strong>Selection Timeline:</strong> Applications will be reviewed, and results will be announced in the <strong>first week of June</strong></li>
          <li><strong>Onboarding:</strong>Selected fellows will be onboarded shortly after the results are announced </li>
        </ul> 
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-20 lg:px-32 font-dmsans">
        ...
        <ul className="list-decimal list-semibold pl-6 text-sm sm:text-base text-justify space-y-2 mb-16 ">
          <li>Work full-time on your startup with financial stability through a monthly stipend</li>
          <li>Be part of a vibrant community of innovators and receive mentorship from seasoned entrepreneurs and IITM alumni </li>
          <li> Gain access to co-working space, capacity-building workshops, and valuable networking opportunities within the IIT Madras entrepreneurial ecosystem</li>
        </ul> 
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-20 lg:px-32 font-dmsans">
      <p className="text-sm sm:text-base text-justify mb-4 mt-4">
      If you’re a recent IIT Madras undergraduate with a promising startup idea and the drive to build something impactful, 
      <strong> Apply now</strong> for the UG–FIR program and take your venture to the next level.
        </p>
        <p className="text-sm sm:text-base text-justify mb-4 mt-4">
  ...
  <strong>Applications are now open – best of luck!</strong>
      ...
      <div className="text-center py-10 px-4 sm:px-6 mt-12">
        <h2 className="text-3xl sm:text-4xl font-bold text-green-700 mb-4 font-dmsans">Fellowship Gallery</h2>
        <select
          value={selectedYear}
